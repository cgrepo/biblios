          ...
          return $.ajax({
            ...
            success: function(data) {
              ...
              return $('.tblSubscriptors').on('dblclick', 'tr', function() {
                return alert($(this).find('td:first').text());
              });
            }
          });
        case 'commitSearchBySubAcc':
          return $.ajax({
            type: 'GET',
