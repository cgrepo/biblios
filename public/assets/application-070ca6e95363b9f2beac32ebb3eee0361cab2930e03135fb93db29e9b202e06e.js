...
(function() {
  var checkRows, cryteriaEnabler, getReturnDay, mySpin, readRents, setUp;
  ...
  $(document).on("turbolinks:load", function() {
      ...
      if (checkRows('subscriptors') > 0 && checkRows('books') > 0) {
        ...
        return $.ajax({
          ...
          success: function(data) {
            ...
            return $('.tblBorrowedBooks tbody tr').each(function() {
              var $i;
    ...
    $(document).on('submit', 'form#commitSearchBySubAcc', function(e) {
      ...
      if ($('#acct').val() !== '') {
        ...
        return alert('proporcione un numero de cuenta');
      }
    });
    return $(document).on('submit', 'form#commitSearchByName', function(e) {
      e.preventDefault();
      if ($('#name').val() !== '') {
        mySpin('s');
        return $.ajax({
