...
class BlockedsControllerTest < ActionController::TestCase
  ...
  test "should create blocked" do
    assert_difference('Blocked.count') do
      post :create, blocked: { end: @blocked.end, notes: @blocked.notes, subscriptor_id: @blocked.subscriptor_id }
    end
  ...
  test "should update blocked" do
    patch :update, id: @blocked, blocked: { end: @blocked.end, notes: @blocked.notes, subscriptor_id: @blocked.subscriptor_id }
    assert_redirected_to blocked_path(assigns(:blocked))
  end
